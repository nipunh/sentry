...
import {builtinModules} from 'node:module'; // ).builtinModules;
...
export default [
  {
    // Default glob pattern is: "**/*.{js,mjs,cjs}"
    files: ['**/*.js', '**/*.ts', '**/*.tsx'],
  },
  {
    ignores: [
  ...
  {
    plugins: {
      'jest-dom': jestDom, // fixupPluginRules(jestDom),
      'testing-library': testingLibrary,
      'typescript-sort-keys': typescriptSortKeys,
      'react-hooks': reactHooks, // fixupPluginRules(reactHooks),
      '@typescript-eslint': typescriptEslint,
      '@emotion': emotion,
      import: _import, // fixupPluginRules(_import),
      react,
      sentry,
