...
from sentry.sentry_apps.api.endpoints.sentry_app_requests_v2 import SentryAppRequestsEndpointV2
...
SENTRY_APP_URLS = [
    ...
    re_path(
        ...
        SentryAppRequestsEndpointV2.as_view(),
        name="sentry-api-0-sentry-app-requests-v2",
    ),
